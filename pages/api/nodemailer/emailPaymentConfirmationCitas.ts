            ...
            <body style="padding: 20px">
                <div class="container" style="
                    ...
                    <div class="logo" style="
                                ...
                                font-family: Cormorant Garamond;
                            ">
                        <img style="object-fit: cover; width: 200px; margin: 0 auto" src="https://i.postimg.cc/Wbq8HpKC/logo.png"
                ...
                ">
                        <p>Total: ${priceService}€ </p>
                    </div>
                    <hr style="width: 20%; margin: 0 auto; background-color: black; color: black; border-color: black;" />
                    <div class="icon" style="text-align: center; margin-top: 20px">
                        <div style="
                                    ...
                                    font-family: Cormorant Garamond;
                                ">
                            <img style="width: 30px; height: 30px" src="https://i.postimg.cc/5NF1gfK7/icons8-calendar-100.png" />
                            <p style="font-size: 20px; color: black">${date}</p>
                        </div>
                        <div style="align-items: center; text-align: center">
                            <img style="width: 30px; height: 30px" src="https://i.postimg.cc/DwrhVBT1/icons8-time-100-1.png" />
                            <p style="
                                        font-size: 20px;
                                        color: black;
                                        text-align: center;
                    ...
                    <div class="button" style="
                        ...
                        <button style="
                            ...
                            <a style="
                                        ...
                                        color: white;
                                        font-family: Cormorant Garamond;
                                    " href="mailto:hola@sevillaestefarmacia.com">Envíanos un correo</a>
                        </button>
                    </div>
                    <div class="footer" style="text-align: center; margin-top: 3rem">
                        <a href="https://www.instagram.com/sevillaestefarmacia/?hl=es">
                            <img style="width: 30px; margin: 0 10px" src="https://i.postimg.cc/fRnsg16w/icons8-instagram-100-1.png"
                                alt="Instagram" />
                        </a>
                        <a
                            ...
                            <img style="width: 30px; margin: 0 10px" src="https://i.postimg.cc/hGKBKTD6/icons8-marker-100-1.png"
                                alt="Marcador" />
                        </a>
                    </div>
                    <div class="received" style="
                                text-align: center;
                                margin-top: 20px;
                                font-size: 15px;
                                color: black;
